...
local token = '391052362:AAEkaft5yz-cSrz1EzDxyUXIQvF3XCuPKxs' --token
...
sudo = {66488544,158955285,180191663,391052362}
  local var = false
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 391052362 or q.from.id == 66488544 or q.from.id == 180191663 then
